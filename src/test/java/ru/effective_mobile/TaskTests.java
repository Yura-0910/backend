...
class TaskTests {
  ...
  //Проверяем сохранение новой задачи
  @Test
  @Order(3)
  void test_003_saveTask() {
    String strURL = "/api/add";
    String response = "Задача успешно создана";

    TaskDto taskDTO = new TaskDto();
    taskDTO.setHeader("TestHeader");
    taskDTO.setDescription("TestDescription");
    taskDTO.setStatusId(1);
    taskDTO.setPriorityId(2);
    taskDTO.setAuthorId(2);
    taskDTO.setExecutorId(3);
    ...
    assertThat(responseEntity.getBody(), containsString(response));
  }
}